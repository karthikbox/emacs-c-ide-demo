...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Google Drive/GTD/birthday.org" "~/Google Drive/GTD/newgtd.org")))
 '(org-agenda-ndays 7)
...
(setq org-default-notes-file "~/Google Drive/orgfiles/notes.org")
;; (setq remember-annotation-functions '(org-remember-annotation))
;; (setq remember-annotation-functions '(remember-annotation-functions))
...
(defun gtd ()
    (interactive)
    (find-file "~/Google Drive/gtd/newgtd.org")
)
